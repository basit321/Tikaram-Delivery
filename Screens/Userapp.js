            ...
            <VStack width='85%' mx='auto'>
              ...
              <TouchableOpacity activeOpacity={1} onPress={()=>{setotpmodal(true),forDelay()}}>
               <LinearGradient
                        ...
                        style={{ ...styles.Btn }}
                    >
                        <Text style={{ color: "white", fontFamily: 'arabicBold', }}>send</Text>
                    </LinearGradient>
</TouchableOpacity>
            </VStack>
...
<TouchableOpacity activeOpacity={1} onPress={()=>  {setotpmodal1(true)}}>
               <LinearGradient
                        colors={['#37B3A9', '#37B3A9', '#E8E6A5']}
                        start={{ x: 0, y: 0 }}
                        end={{ x: 1, y: 1 }}
...
borderColor: 'rgba(0, 0, 0, 0.1)',
      ...
      ,color:'#9CA3AF',marginLeft:"auto",marginRight:"auto"}} >
                ...
                <TouchableOpacity activeOpacity={1} onPress={()=>  {navigation.navigate('Home'),navigatedelay()} }>
        ...
        <Modal isVisible={Otpmodal1} style={styles.slidemodel}
          
          avoidKeyboard={false}
          onBackButtonPress=  { () =>setotpmodal1(false)}
        >
           <View style={{
...
borderColor: 'rgba(0, 0, 0, 0.1)',
            ...
            <VStack style={{marginTop:24}}>
            <TouchableOpacity activeOpacity={1} onPress={()=>setotpmodal1(false)} >
            <Ionicons name="ios-arrow-back-sharp" size={24} color="#374151" /> 
            </TouchableOpacity>
      ...
      ,color:'#9CA3AF',marginLeft:"auto",marginRight:"auto"}} >
                ...
                <TouchableOpacity activeOpacity={1} onPress={()=>  {navigatedelay1()} }>
